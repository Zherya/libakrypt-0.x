...
typedef struct esp {
    ...
    /*! \brief Значение длины, до которой выравниваются полезные данные
     * с помощью TFC-заполнения (0 - TFC-заполнение не используется) */
    size_t tfclen;
} *ak_esp;
...
/* ----------------------------------------------------------------------------------------------- */
/*! \brief Функция устанавливает или сбрасывает использование TFC-заполнения. */
int ak_esp_context_set_tfc_length(ak_esp , size_t );
...
size_t ak_esp_context_write_packet( ak_esp , ak_pointer , size_t , ak_uint8 , ak_uint8 *);
